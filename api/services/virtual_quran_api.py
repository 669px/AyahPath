...
KEYWORD_CATEGORY_MAP = {
    "stress": ("stress", "anxiety", "worried", "worry", "fear", "panic", "overwhelmed", "hardship"),
    "anger": ("angry", "anger", "furious", "mad", "rage", "temper"),
    "jealousy": ("jealous", "envy", "envious", "resent"),
    "gratitude": ("grateful", "gratitude", "thankful", "blessing", "blessings"),
    "forgiveness": ("forgive", "forgiveness", "repent", "mercy", "pardon"),
    "trust_in_allah": ("trust", "tawakkul", "rely", "future", "uncertain", "reliance"),
    "patience": ("patient", "patience", "sabr", "waiting", "trial", "trials"),
    "charity": ("charity", "donate", "donation", "sadaqah", "giving"),
    "lying": ("lie", "lying", "dishonest", "false", "truth"),
    "arrogance": ("arrogant", "arrogance", "pride", "ego", "boast"),
}
        ...
        result.append(
            {
                ...
                "verse": _copy_verse(verse, translation_ids=translation_ids, include_words=include_words),
            }
        )
    return result
